...
class PhotoTypeAutoFixture extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $photoType0->setCreatedAt(new \DateTime('2026-05-20 22:32:22'));
        $photoType0->setUpdatedAt(new \DateTime('2026-05-20 22:32:22'));
        ...
        $photoType1->setCreatedAt(new \DateTime('2026-05-20 22:32:22'));
        $photoType1->setUpdatedAt(new \DateTime('2026-05-20 22:32:22'));
        ...
        $photoType2->setCreatedAt(new \DateTime('2026-05-20 22:32:22'));
        $photoType2->setUpdatedAt(new \DateTime('2026-05-20 22:32:22'));
        ...
        $photoType3->setCreatedAt(new \DateTime('2026-05-20 22:32:22'));
        $photoType3->setUpdatedAt(new \DateTime('2026-05-20 22:32:22'));
        ...
        $photoType4->setCreatedAt(new \DateTime('2026-05-20 22:32:22'));
        $photoType4->setUpdatedAt(new \DateTime('2026-05-20 22:32:22'));
