...
class ProjectAutoFixture extends Fixture implements FixtureGroupInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $project0->setDescription('<div>Projet orienté recherche et structures de données complexes : modélisation et implémentation d\'une bibliothèque bas niveau interconnectée avec un outil de data-mining.</div><p class="text-center mt-5"><a class="btn btn-flat btn-nine waves-effect waves-light hvr-grow-shadow" href="https://docs.carolinenoyer.fr/pdf/cnoyer-rapport-stage-maitrise-2004.pdf" target="_blank" title="Rapport de stage"><i class="fas fa-paperclip mr-5" aria-hidden="true"></i> Rapport de stage</a></p>');
        $project0->setScreenshots(null);
        ...
        $project4->setUpdatedAt(new \DateTime('2026-06-05 22:21:10'));
