...
class SkillTypeAutoFixture extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $skillType1->setUpdatedAt(new \DateTime('2026-05-23 18:10:55'));
        ...
        $skillType2->setUpdatedAt(new \DateTime('2026-05-23 18:10:55'));
        ...
        $skillType3->setUpdatedAt(new \DateTime('2026-05-23 18:10:55'));
        ...
        $skillType6->setUpdatedAt(new \DateTime('2026-05-23 18:10:55'));
        ...
        $skillType7->setUpdatedAt(new \DateTime('2026-05-23 18:10:55'));
        ...
        $skillType8->setUpdatedAt(new \DateTime('2026-05-23 18:10:55'));
