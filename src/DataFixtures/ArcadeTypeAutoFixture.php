...
class ArcadeTypeAutoFixture extends Fixture implements FixtureGroupInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $arcadeType0->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType0->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType1->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType1->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType2->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType2->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType3->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType3->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType4->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType4->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType5->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType5->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType6->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType6->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType7->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType7->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType8->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType8->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType9->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType9->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
        ...
        $arcadeType10->setCreatedAt(new \DateTime('2026-05-27 16:03:19'));
        $arcadeType10->setUpdatedAt(new \DateTime('2026-05-27 16:03:19'));
