...
class CompanyAutoFixture extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $company0->setCreatedAt(new \DateTime('2026-05-20 22:46:52'));
        $company0->setUpdatedAt(new \DateTime('2026-05-20 22:46:52'));
        ...
        $company1->setCreatedAt(new \DateTime('2026-05-20 22:46:52'));
        $company1->setUpdatedAt(new \DateTime('2026-05-20 22:46:52'));
        ...
        $company2->setCreatedAt(new \DateTime('2026-05-20 22:46:52'));
        $company2->setUpdatedAt(new \DateTime('2026-05-20 22:46:52'));
        ...
        $company3->setCreatedAt(new \DateTime('2026-05-20 22:46:52'));
        $company3->setUpdatedAt(new \DateTime('2026-05-20 22:46:52'));
        ...
        $company4->setCreatedAt(new \DateTime('2026-05-20 22:46:52'));
        $company4->setUpdatedAt(new \DateTime('2026-05-20 22:46:52'));
        ...
        $company5->setCreatedAt(new \DateTime('2026-05-20 22:46:52'));
        $company5->setUpdatedAt(new \DateTime('2026-05-20 22:46:52'));
        ...
        $company6->setCreatedAt(new \DateTime('2026-05-20 22:46:52'));
        $company6->setUpdatedAt(new \DateTime('2026-05-20 22:46:52'));
        ...
        $company7->setCreatedAt(new \DateTime('2026-05-20 22:46:52'));
        $company7->setUpdatedAt(new \DateTime('2026-05-20 22:46:52'));
